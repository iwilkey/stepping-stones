...
public class Recording : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		cc = GameObject.Find("Record Canvas").GetComponent<CameraCapture>();
		maxFrames = cc.numFrames; frameRate = cc.fps;

		// Prepare the data directory
		persistentDataPath = Application.persistentDataPath + "/UnprocessedFrames";
